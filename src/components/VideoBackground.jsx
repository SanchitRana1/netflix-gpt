...
const VideoBackground = ({ movieId }) => {
  ...
  const [plaVid, setPlayVid] = useState(true);
  const onMouseOver = () => {
  ...
  return (
    <div className="videoDiv" onMouseOver={onMouseOver} onMouseLeave={
      onMouseLeave}>
      <iframe
        ...
        src={
          ...
          trailerVideo?.key +
          "?si=cyTV9JeXQFpq6DdT&mute=1&autoplay="+[!showTrailerVideoTitle?"1":"0"]+"&controls=0&showinfo=0&loop=1"
        }
